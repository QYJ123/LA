...
class GlidingvertexHead(RPNTestMixin, OBBAnchorHead):
    """RPN head.
    ...
    def __init__(self, in_channels, **kwargs):
        super(GlidingvertexHead, self).__init__(
            1,
            in_channels,
            bbox_type='obb',
            reg_dim=8,
    ...
    def _init_layers(self):
        ...
        self.rpn_reg = nn.Conv2d(self.feat_channels, self.num_anchors * 8, 1)
    ...
    def loss(self,
        ...
        """
        losses = super(GlidingvertexHead, self).loss(
            cls_scores,
            bbox_preds,
            gt_bboxes,
            None,
